...
const { AdyenCheckout, CashAppPay } = window.AdyenWeb;
...
async function startCheckout() {
  try {
    ...
    const cashAppConfig = {
      showPayButton: true,
      // Set to true to let the shopper choose whether to save their payment details.
    ...
    const cashApp = new CashAppPay(checkout, cashAppConfig).mount(
      "#component-container"
    );
  } catch (error) {
    console.error(error);
